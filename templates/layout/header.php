...
<head>
    ...
    <link href="/assets/css/maniforge-brand-theme.css" rel="stylesheet">
    <?php endif; ?>
    <script>
    (function () {
        try {
...
<body class="app-site<?= $brandThemeEnabled ? ' mf-brand-theme mf-ru-embedded' : '' ?>">
<?php if ($activeNav === 'api'): ?>
<script>
(function () {
    try {
...
<?php endif; ?>
<?php if ($brandThemeEnabled): ?>
<?php require __DIR__ . '/mf-ru-shell.php'; ?>
<?php else: ?>
