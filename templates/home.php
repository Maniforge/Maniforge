...
if ($brandThemeEnabled) {
    $branding['app_eyebrow'] = 'Go · self-host · РФ · продукт Maniforge';
    $branding['app_headline'] = 'Модульная B2B-платформа';
    $branding['app_tagline'] = 'Tenant, RBAC, склад и 152‑ФЗ — в вашем контуре';
    $branding['app_lead'] = 'API-first движок для self-host: подключайте модули вместо монолита. Страница продукта в каталоге Maniforge — /app/maniforge.';
    $pageTitle = 'Maniforge Platform — модульный B2B-движок | Maniforge';
} else {
...
$quickLinks[] = ['label' => 'API', 'href' => '/api', 'kind' => 'ghost', 'icon' => 'terminal'];
