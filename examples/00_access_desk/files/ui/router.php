...
/**
 * Dev router for Access Desk UI: static files + same-origin proxy to Maniforge.
 * php -S 127.0.0.1:8760 router.php
 */
...
// Parent example assets (manifest JSON lives next to ui/)
if ($uri === '/manifest.access_pass.json') {
    $path = dirname(__DIR__) . '/manifest.access_pass.json';
    if (is_file($path)) {
