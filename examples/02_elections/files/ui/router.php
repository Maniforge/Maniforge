...
/** Elections UI + Maniforge proxy. php -S 127.0.0.1:8763 router.php */
...
foreach (['manifest.election_event.json', 'manifest.polling_station.json', 'manifest.candidacy.json'] as $name) {
    if ($uri === '/' . $name) {
